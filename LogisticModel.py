...
class LogisticModel:
    ...
    def __init__(self, data, numContinuous, subspaceDimension, normalizing_radius, lambda_num, data2):
    ...
    def getProbabilityEstimators(self, elements,y=None):
            ...
            #Needed for large enough datasets, as np.prod can overflow, if used
            log_p = np.log(p)
